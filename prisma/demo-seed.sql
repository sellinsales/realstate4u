...
INSERT INTO `Profile` (`id`, `userId`, `name`, `phone`, `country`, `city`, `createdAt`, `updatedAt`) VALUES
...
-- Add demo properties
INSERT INTO `PropertyListing` (`id`, `slug`, `title`, `description`, `price`, `country`, `city`, `address`, `propertyType`, `listingType`, `marketCode`, `bedrooms`, `bathrooms`, `areaSqm`, `createdById`, `status`, `createdAt`, `updatedAt`) VALUES
...
INSERT INTO `HousingQueue` (`id`, `propertyId`, `type`, `selectionMethod`, `createdAt`, `updatedAt`) VALUES
('queue-pk-001', 'prop-pk-001', 'QUEUE', 'First-come-first-served with preference points', NOW(), NOW());

-- Add demo leads/inquiries
INSERT INTO `Lead` (`id`, `propertyId`, `userId`, `name`, `email`, `phone`, `message`, `source`, `createdAt`) VALUES
...
INSERT INTO `HousingApplication` (`id`, `propertyId`, `userId`, `status`, `note`, `createdAt`, `updatedAt`) VALUES
